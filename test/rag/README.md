...
Objetivo: Desarrollar un assistente para guiar a los usuarios en la seleccion de productos y el posterior proceso de checkout (efectuar pago y generar el envio del producto) de manera conversacional. (Trabajo Practico N2)
...
Intefase Grafica: Linea de comandos
...
Intefase Grafica: Consumo a traves de Servidor API
